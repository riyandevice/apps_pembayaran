...
?> 
    ...
    <div class="page-content-wrap">
	 ...
	 <div class="panel panel-primary">
	        ...
	        <strong>MOHON DIPERHATIKAN !</strong> Pembayaran Tunggakan, bisa dilakukan hanya pada menu "Transaksi Tunggakan"
	    </div>
	        ...
	        <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
	        <strong>MOHON DIPERHATIKAN !</strong> Pembayaran Tunggakan, mohon dilihat dengan melihat Pembayaran apa dan Kelas Sebelumnya yang mengalami Tunggakan
	    </div>
                    ...
                    <div class="panel-body table-responsive">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <?php 
                                    $i=1;
                                    $histori = $config->getData("SELECT * FROM tbl_transaksi t, tbl_siswa s, tbl_pegawai p WHERE t.id_kelas = '". $kelas_siswa ."' AND t.id_siswa = s.id_siswa AND t.id_pegawai = p.id_pegawai AND t.id_siswa='". $r['id_siswa'] ."'");
                                    foreach ($histori as $h) 
									{
                                ?>
                                <tr>
